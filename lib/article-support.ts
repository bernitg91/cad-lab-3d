...
const media = {
  ...
  step: {
    image: "/images/editorial/intercambio-step-cad.webp",
    alt: "Ilustración de un diseñador revisando un conjunto CAD antes de intercambiar un archivo STEP",
    caption: "Ilustración editorial: exportar no cierra la entrega; conviene reabrir el archivo neutro y comprobar sólidos, escala, estructura y versión."
  },
  project: {
    image: "/images/editorial/documentacion-prototipo-evidencias.webp",
    alt: "Ilustración de una mesa de proyecto con prototipo, planos, notas y calibre",
    caption: "Ilustración editorial: una memoria técnica gana valor cuando cada plano, medida y fotografía demuestra una decisión concreta."
  },
  warping: {
    image: "/images/editorial/diagnostico-warping-fdm.webp",
    alt: "Ilustración de una pieza FDM con una esquina levantada sobre la cama de impresión",
    caption: "Ilustración editorial: registrar cuándo y dónde se levanta una pieza ayuda a separar problemas de primera capa, contracción y geometría."
  },
  materials: {
...
const entries: Record<string, Entry> = {
  "calibrar-impresora-3d-piezas-funcionales": entry("panel", "warping", ["prusaLayers"], "Calibra con una secuencia corta y medible; cambiar cinco parámetros a la vez impide saber qué ha mejorado.", "En taller conviene guardar una pieza patrón con fecha, material y perfil. Si una impresión funcional empieza a fallar, repetir ese patrón permite separar un problema de máquina de un problema de geometría.", ["Comprueba primera capa y flujo antes de ajustar tolerancias.", "Mide paredes y agujeros con el mismo material de la pieza final.", "Cambia una variable, imprime y anota el resultado."]),
  ...
  "documentar-proyecto-diseno-industrial": entry("project", "watch", [], "La memoria debe contar una cadena de decisiones verificable, no una cronología de tareas ni una galería de renders.", "El soporte de relojes muestra una secuencia clara: necesidad de orden, apoyos repetidos, base estable, fabricación FDM y revisión del uso. Esa lógica es más valiosa que mostrar veinte vistas sin explicación.", ["Formula el problema y los requisitos antes de enseñar la forma.", "Vincula cada decisión importante con una evidencia.", "Cierra con límites, cambios y siguiente iteración."]),
