---
title: "Checklist para revisar un portfolio de diseño industrial"
slug: "checklist-portfolio-diseno-industrial"
description: "Lista práctica para revisar estructura, proyectos, renders, textos, proceso y claridad técnica de un portfolio."
...
- [ ] Datos de contacto y ubicación o disponibilidad están actualizados.
- [ ] Herramientas y nivel se describen sin exageraciones.
- [ ] El documento funciona sin depender de una explicación oral.

Si aún estás definiendo la estructura, empieza por [cómo crear un portfolio técnico de diseño industrial](/blog/crear-portfolio-tecnico-diseno-industrial).
...
Abre una página al azar y responde:

- ¿Qué problema se estaba resolviendo?
- ¿Qué hiciste tú?
- ¿Qué decisión técnica destaca?
- ¿Qué evidencia muestra el resultado?

Si no puedes contestar sin leer varios párrafos, mejora títulos, pies de foto y jerarquía. La guía para [documentar un proyecto de diseño industrial](/blog/documentar-proyecto-diseno-industrial) ayuda a convertir el proceso en una narración trazable.
...
- [ ] Los renders explican forma, escala y uso, no solo estilo.
- [ ] Las imágenes técnicas tienen título o pie breve.
- [ ] El resultado se relaciona con los requisitos iniciales.

Para seleccionar imágenes, consulta [renders técnicos para portfolio](/blog/renders-tecnicos-portfolio) y [cómo preparar planos desde un modelo CAD](/blog/preparar-planos-tecnicos-modelo-cad). No es obligatorio incluir ambos: elige la evidencia que demuestre la habilidad buscada.
...
Utiliza un título de proyecto, una frase de contexto, subtítulos descriptivos y pies que aporten información nueva. Evita bloques largos en mayúsculas, párrafos sobre fondos complejos o textos que repiten exactamente lo visible en la imagen.

## 5. Haz una revisión final de entrega

- [ ] Portada, índice y numeración coinciden.
- [ ] No quedan textos de plantilla ni imágenes temporales.
- [ ] Ortografía, unidades y nombres de software están revisados.
- [ ] Los enlaces se abren y usan permisos públicos correctos.
- [ ] El PDF tiene un nombre profesional y una versión.
- [ ] Existe una copia ligera para correo y otra de mayor calidad si hace falta.
- [ ] Una tercera persona ha explicado qué recuerda tras cinco minutos.

Prepara además una explicación oral breve con [cómo presentar un proyecto CAD en una entrevista](/blog/presentar-proyecto-cad-entrevista-practicas). El portfolio abre la conversación; no necesita contener cada detalle de la memoria.
...
Un buen portfolio permite comprender qué sabes hacer, cómo tomas decisiones y qué parte puedes defender. Revisa primero estrategia y contenido, luego evidencia técnica y, al final, acabado visual. Ese orden evita pulir páginas que quizá no deberían estar en la selección.
