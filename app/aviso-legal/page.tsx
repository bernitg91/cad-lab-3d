  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="article-body mt-8">
        ...
        <h2>Titularidad</h2>
        <p>
          El titular y responsable editorial de CAD Lab 3D es {siteConfig.authorName}. Para consultas sobre titularidad, correcciones, retirada de contenido o colaboración, utiliza la página de contacto o escribe a <a href={`mailto:${siteConfig.contactEmail}`}>{siteConfig.contactEmail}</a>.
        </p>
        <h2>Contenido</h2>
        <p>
