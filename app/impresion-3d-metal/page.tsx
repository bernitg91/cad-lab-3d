...
const guide = getTopicGuide("impresion-3d-metal");
export const metadata = createPageMetadata({ title: guide.title, description: guide.description, path: "/impresion-3d-metal" });
